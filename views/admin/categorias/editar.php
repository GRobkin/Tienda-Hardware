<?php /** Vista: admin/categorias/editar.php — Variables: $categoria, $alertas */ ?>
...
<form method="POST" action="/admin/categorias/editar?id=<?php echo (int)$categoria->id; ?>">
<div class="uk-card uk-card-default uk-card-body">
    ...
    <div class="uk-margin">
        ...
        <input id="slug" name="slug" class="uk-input" type="text" value="<?php echo s($categoria->slug ?? ''); ?>" required>
    </div>
    <div class="uk-margin">
