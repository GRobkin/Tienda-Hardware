<?php /** Vista: admin/subcategorias/crear.php — Variables: $subcategoria, $categorias, $alertas */ ?>
...
<form method="POST" action="/admin/subcategorias/crear">
<div class="uk-card uk-card-default uk-card-body">
    ...
    <div class="uk-margin">
        ...
        <select id="categoria_id" name="categoria_id" class="uk-select" required>
            ...
            <option value="<?php echo (int)$cat->id; ?>" <?php echo ($subcategoria->categoria_id ?? null) == $cat->id ? 'selected' : ''; ?>>
