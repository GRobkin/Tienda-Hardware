...
class AdminController {
    ...
    public static function dashboard(Router $router) {
        ...
        $resultado = \Model\ActiveRecord::consultarSQL(
            "SELECT COALESCE(SUM(total),0) as ingresos FROM ordenes WHERE estado = 'pagado'"
        );
